...
assert.match(source, /DUPLICATE_RESEARCH_STAMP/);
assert.match(source, /pmf_research_stamp_identity/);
assert.match(source, /intended_market_session/);
assert.match(source, /intendedMarketSessionForStamp/);
assert.match(source, /isXnysSessionDate/);
